...
GATEWAY_MODULE = u'网关模块'
GATEWAY_NAME = u'网关名称'
GATEWAY_DISPLAY_NAME = u'网关显示名称'
USER_ID = u'用户ID'
PASSWORD = u'密码'
BROKER_ID = u'经纪商ID'
TD_ADDRESS = u'交易服务器'
MD_ADDRESS = u'行情服务器'
AUTH_CODE = u'授权码'
USER_PRODUCT_INFO = u'用户产品信息'
CONNECT_ON = u'连接'
CONNECT_UNKNOWN = u'未知'
CONNECT_OFF = u'断开'
CONNECT_STATUS = u'连接状态'

SELECT_ALL = u'全选'
SELECT_REVERSE = u'反选'
DELETE_SELECTED = u'删除选中'
CONNECT_SELECTED = u'选中连接'
DISCONNECT_SELECTED = u'选中断开'
CONNECT_ALL = u'全部连接'
DISCONNECT_ALL = u'全部断开'
