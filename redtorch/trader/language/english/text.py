...
CONNECTION_MANAGER = u'Connection Manager'
EXIT = u'Exit'
...
GATEWAY_MODULE = u'Gateway Module'
GATEWAY_NAME = u'Gateway Name'
GATEWAY_DISPLAY_NAME = u'Gateway Display Name'
USER_ID = u'User ID'
PASSWORD = u'Password'
BROKER_ID = u'BrokerID'
TD_ADDRESS = u'Trader Address'
MD_ADDRESS = u'Market Address'
AUTH_CODE = u'Auth Code'
USER_PRODUCT_INFO = u'User Product Info'
CONNECT_ON = u'Online'
CONNECT_OFF = u'Offline'
CONNECT_UNKNOWN = u'Unknown'
CONNECT_STATUS = u'Status'

SELECT_ALL = u'Select All'
SELECT_REVERSE = u'Select Reverse'
ADD = u'Add'
EDIT = u'Edit'
DELETE_SELECTED = u'Delete Selected'
CONNECT_SELECTED = u'Connect Selected'
DISCONNECT_SELECTED = u'Disconnect Selected'
CONNECT_ALL = u'Connect All'
DISCONNECT_ALL = u'Disconnect All'
...
SAVE_AND_CONNECT = u'Save And Connect'
